...
**2.** English has a suffix ¡Ven whose use is illustrated in the following lists:
...
A. What part of speech does the suffix ¡Ven attach to? That is, what is the part of speech of the words in list A?


B. When the suffix ¡Ven is attached to a word, what part of speech is the resulting word? Give some specific morphological properties of one of the words in list B, in order to justify your answer.
